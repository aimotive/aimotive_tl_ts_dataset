...
* [aiMotive Multimodal Dataset](https://github.com/aimotive/aimotive_dataset) - This work introduces a multimodal (camera, LiDAR, radar) dataset for robust autonomous driving with long-range perception and trained unimodal and multi-modal baseline models for 3D object detection.
* [aiMotive 3D Traffic Light and Sign Dataset](https://github.com/aimotive/aimotive_tl_ts_dataset) - The dataset was introduced in the 'Accurate 3D Automatic Annotation of Traffic Lights and Signs for Autonomous Driving' paper. The dataset consists of 3D bounding boxes of traffic lights and traffic signs up to 200 meters from the ego vehicle..
